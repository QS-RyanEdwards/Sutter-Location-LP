...
var UIElements=function(){function e(e){return"("+(e=String(e)).slice(0,3)+") "+e.slice(3,6)+"-"+e.slice(6)}return{DOM:function(){var e=$("#zip-input"),t=$("#change-zip"),n=$("#zip-error-message"),o=$("#loading-indicator"),i=$("#no-results"),r=$(".city-name"),a=$(".find-your-doctor-link"),s=$(".family-doctor-link"),c=$(".internal-med-link"),l=$(".pediatrician-link"),u=!1,p=function(e,t){t?e.show():e.hide()},d=function(e,t){e.attr("href",t)};return{getZip:function(){return e.val()},onChangeZip:function(n){var o=function(e){u||n(e)};t.click(o),e.keypress(function(e){13==e.keyCode&&o(e)})},setZipError:function(e){p(n,e)},setNoResults:function(e){p(i,e)},setLoader:function(e){p(o,e),o.attr("aria-busy",e),u=e},setFindDoctorLinks:function(e){d(a,e)},setFamilyDoctorLinks:function(e){d(s,e)},setInternalMedLinks:function(e){d(c,e)},setPediatricianLinks:function(e){d(l,e)},setCityName:function(e){r.text("Find good primary care in "+e)},initVenobox:function(){$(".venobox").venobox({overlayColor:"rgba(0,86,149,1)",closeBackground:"#00aaa6",closeColor:"#fff"})}}}(),GoogleMap:function(){var t=function(t){var n=t.address;return"<p>"+(n.label?"<center><b>"+n.label+"</b></center><br/>":"")+n.street+"<br/>"+n.city+", "+n.state+" "+n.zip+"<br/>ph: "+e(n.phone)+"</p>"},n=function(e,n){var o=new google.maps.Marker({map:e,position:n.address.latLng,icon:"assets/images/icons/mapicon.png"}),i=new google.maps.InfoWindow({content:t(n)});o.addListener("click",function(){i.open(e,o)})},o=function(e,t,n){var o=new google.maps.LatLngBounds;o.extend(t);for(var i=0;i<n.length;i++)o.extend(n[i].address.latLng);e.fitBounds(o)};return{displayProviders:function(e,t){for(var i=document.getElementById("map1"),r=new google.maps.Map(i,{zoom:10,center:t}),a=0;a<e.length;a++)n(r,e[a]);e.length&&o(r,t,e)}}}(),Carousel:function(){var t,n={nav:!0,dots:!1,margin:15,loop:!1,navText:["<span class='icon-chevron-left icon-white'>&#xf104;</span>","<span class='icon-chevron-right icon-white'>&#xf105;</span>"],responsive:{0:{items:1},768:{items:2},990:{items:3}}},o=function(t){var n=t.firstName+" "+t.lastName+" "+t.physicianTitle,o=t.address,i=t.address.phone,r=e(i),a=t.foundation?"<p>"+t.foundation+"</p>":"",s="http://www.sutterhealth.org/"+t.url,c=t.epicOpenSchedulingURL||t.appointmentRequestUrl||"",l=t.epicOpenSchedulingURL?"Book an Appointment":"Request an Appointment",u=c?'<a href="'+c+'" class="btn custom-btn btnPrimaryOrange" tabindex="0" target="_blank">'+l+"</a>":"";return'<table class="drTable"><tr class="textCenter nameRow"><td colspan="2" ><h3 class="doctorname">'+n+"</h3>"+a+'</td></tr><tr class="contactRow"><td><img src="'+t.image+'" alt="photo of '+n+'"></td><td valign="top" class="contactInfo"><p class="doctorinfo">'+o.street+"<br/> "+o.city+", "+o.state+" "+o.zip+'</p><p class="doctorinfo"><a href="tel:'+i+'" rel="nofollow">'+r+'</a></p><div class="columnFlexItem columnFlexItemVBottom"><div>'+u+'<br /><a href="'+s+'" tabindex="0" target="_blank">View Profile</a><br /></div></div></td></tr></table>'};return{init:function(){(t=$("#client-slider")).owlCarousel(n)},displayProviders:function(e){t.trigger("replace.owl.carousel",[$("")]);for(var n=0;n<e.length;n++)t.trigger("add.owl.carousel",[$(o(e[n]))]);t.trigger("refresh.owl.carousel")}}}()}}(),Services={Location:function(){var e={zip:"95816",city:"Sacramento",latLng:{lat:38.58001840000001,lng:-121.46275760000003}};return{getLocationFromIP:function(){return new Promise(function(t,n){$.getJSON("http://freegeoip.net/json/?callback=?").done(function(n){t(n.zip_code&&n.country_code&&"US"==n.country_code?{zip:n.zip_code,city:n.city,latLng:{lat:n.latitude,lng:n.longitude}}:e)}).fail(function(n){console.log("geolocation error:",n),t(e)})})},getLocationFromZip:function(e,t,n){return new Promise(function(o,i){var r=new google.maps.Geocoder,a=function(e){return e.formatted_address.match(/^[^,]*/)[0]},s=function(e){var t=e.geometry.location;return{lat:t.lat(),lng:t.lng()}};n&&n(!0);var c={componentRestrictions:{country:"US",postalCode:e}};r.geocode(c,function(r,c){"OK"===c?o({zip:e,city:a(r[0]),latLng:s(r[0])}):(n&&n(!1),t&&t(!0),i(c))})})}}}(),SutterAPI:function(){var e={AdultPrimaryCare:1184,FamilyMedicine:517,InternalMedicine:518,Pediatrics:519},t=function(e){return"http://www.sutterhealth.org/fadapi/?zip="+e+"&r=50&l=50&s=1184"},n=function(e){for(var t=[],n=0;n<e.length;n++)p=e[n].provider,t.push({acceptingAppts:p.specialties[0]&&"Open"==p.specialties[0].status,address:function(e){for(var t,n={},o=0;o<e.addresses.length;o++)if((t=e.addresses[o]).distanceFromSourceGeocode<=50){n=t;break}return{city:n.city,distance:n.distanceFromSourceGeocode,label:n.label,latLng:function(){var e=n.geocode.split(",");return{lat:Number(e[0]),lng:Number(e[1])}}(),phone:n.phone,state:n.state,street:n.street,zip:n.zip}}(p),appointmentRequestUrl:p.appointmentRequestUrl,epicOpenSchedulingURL:p.epicOpenSchedulingURL,firstName:p.firstName,foundation:p.foundations&&p.foundations[0]?p.foundations[0].name:null,image:p.image,lastName:p.lastName,physicianTitle:p.physicianTitle,url:p.url});return t},o=function(e){var t=function(e){return e.epicOpenSchedulingURL?2:e.appointmentRequestUrl?1:0};return(e=function(e,t){for(var n=[],o=0;o<e.length;o++)t(e[o])&&n.push(e[o]);return n}(e,function(e){return e.acceptingAppts})).sort(function(e,n){return t(n)-t(e)||e.address.distance-n.address.distance}),e};return{getProviders:function(e,i,r){return new Promise(function(a,s){var c=t(e);$.getJSON(c).done(function(e){if(e.error&&400==e.error.errorCode)i&&i(!0),s(e);else if(e.resources){var t=n(e.resources);t=(t=o(t)).slice(0,9),a(t)}else a([])}).fail(s).always(function(){r&&r(!1)})})},getDoctorURLs:function(t,n){var o=function(e,t,n){return"http://www.sutterhealth.org/providersearch/?vs=results&action=provSearch&zip="+e+"&medgrp="+t+"&primSpec="+n+"&miles=50&practiceStatus=147&sp=2&sitecfg=75&tmpsubspec=&ziprequired=0&hidehplan=1&wtnonphysspecialty=&st=&wtonline=no&gender=0&miscaffl=0&language=0&onlineSort=936"},i=n||{},r=i.FC||"",a=e;return{findDoctorURL:o(t,i.APC?r:"",a.AdultPrimaryCare),familyDoctorURL:o(t,i.FM?r:"",a.FamilyMedicine),internalMedURL:o(t,i.IM?r:"",a.InternalMedicine),pediatricianURL:o(t,i.Ped?r:"",a.Pediatrics)}}}}(),ZipData:function(){var e=null;return{loadData:function(){return new Promise(function(t,n){$.getJSON("assets/json/zip-data.json").done(function(n){e=n,t(n)}).fail(n)})},getDataForZip:function(t){return e?e[t]:(console.log("Load zip data first."),null)}}}()};$(document).ready(function(){function e(){var e=n.getZip(),t=/^\d{5}$/.test(e);return n.setZipError(!t),t?e:null}function t(e){return a.getProviders(e.zip,n.setZipError,n.setLoader).then(function(t){n.setNoResults(!t.length);var r=s.getDataForZip(e.zip),c=a.getDoctorURLs(e.zip,r);n.setFindDoctorLinks(c.findDoctorURL),n.setFamilyDoctorLinks(c.familyDoctorURL),n.setInternalMedLinks(c.internalMedURL),n.setPediatricianLinks(c.pediatricianURL),n.setCityName(e.city),o.displayProviders(t,e.latLng),i.displayProviders(t)})}var n=UIElements.DOM,o=UIElements.GoogleMap,i=UIElements.Carousel,r=Services.Location,a=Services.SutterAPI,s=Services.ZipData;n.onChangeZip(function(){var o=e();o&&r.getLocationFromZip(o,n.setZipError,n.setLoader).then(t).catch(console.log)}),n.initVenobox(),i.init(),n.setLoader(!0),s.loadData().then(r.getLocationFromIP).then(t).catch(console.log)});